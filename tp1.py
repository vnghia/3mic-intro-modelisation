...
while time < tmax:
    ...
    print(" TIME ITERATION : ", time, r" \ ", tmax)
    U1 = tp.schema1(U1, J, alpha)  # Mise a jour de la solution schema 1
    U2 = tp.schema2(U2, J, alpha)  # Mise a jour de la solution schema 2
    U3 = tp.schema3(U3, J, alpha)  # Mise a jour de la solution schema 3
    time += dt_reel  # Incremente le temps
